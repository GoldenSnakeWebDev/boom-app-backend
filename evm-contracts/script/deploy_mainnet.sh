...
# forge script ./script/DeployMarketplace.s.sol:DeployScript --rpc-url ${MAINNET_RPC} --private-key ${PRIVATE_KEY} --etherscan-api-key ${ETHERSCAN_API_KEY}  --verify --broadcast -vvvv